...
<head>
    ...
    <title>Delete Accessories Information</title>
    ...
    <div class="container" style="padding:0px;">
        <div class="row">
            ...
            <div class="col-lg-8 mt-3">
                ...
                <h3>Delete /Remove Accessories Info / Step 2/4</h3>
                <hr>
                <?php
                  ...
                  $sql = "select * from accessories where acc_id=$acc_id";
                ...
                ?>
                <form action="delete_accessories_3.php" method="post" class="form my-5 col-lg-8 col-md-8">
                    ...
                    <div class="form-group" style="margin-bottom:20px;">
                        ...
                        <?php
                          if($row['picture']!="default.jpg"){
                            ?>
                              <img src="pictures/thumbs/<?php echo $row['picture'];?>" alt="picture">
                            <?php
                          }
                         ?>
                ...
                <div class="alert alert-dismissible alert-danger">
                    ...
                    <strong>Sorry</strong>
                    No Records were found for Accessories ID <?php echo $acc_id; ?>
                    <br>
                    <a href="delete_accessories_1.php" class="btn btn-danger mt-5">Try Again</a>
                </div>
                <?php
              }
                 ?>
