    ...
    <div class="container" style="padding:0px;">
        <div class="row">
            ...
            <div class="col-lg-8 mt-3">
                ...
                <h3>Delete /Remove Accessories Info / Step 1/4</h3>
                <h4 class="text-info">Enter Accessories ID to locate the record</h4>
                <hr>

                <form action="delete_accessories_2.php" method="post" class="form my-5 col-lg-8 col-md-8">
                    <div class="form-group" style="margin-bottom:20px;">
                        <label class="form-label mt-4" for="inputValid">Accessories ID</label>
                        <input type="text"
                        value="" name="acc_id"
                        class="form-control" id="inputValid">
                        <div class="valid-feedback">acc_id is ok</div>
