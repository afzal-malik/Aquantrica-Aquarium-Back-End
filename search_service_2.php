    ...
    <div class="container" style="padding:0px;">
        <div class="row">
            ...
            <div class="col-lg-8 mt-3">
                ...
                <h3>Search Service Info / Step 2/2</h3>
                <h4 class="text-info">Search for the Service Records</h4>
                <hr>
        ...
        <div class="col-lg-12 col-md-12">
          ...
          <table class="table table-bordered table-striped table-hover">
            ...
            <?php
                ...
                switch($search_by){
                  case "service_id":
                    $sql = "select * from service where service_id=$keywords";
                    break;
                  case "service_type":
                    $sql  = "select * from service where service_type='$keywords'";
                    $sql .= " or service_type like '%$keywords%'";
                    break;
                  case "description":
                    $sql = "select * from service where description='$keywords' or description like '%$keywords%'";
                    break;
                  case "price":
                   $sql = "select * from service where price <= $keywords";
                   break;
                }
                ...
                if(mysqli_num_rows($rs) > 0){
                  while($row = mysqli_fetch_assoc($rs)){
                    ...
                    <tr>
                      ...
                      <td style="width:15%">
                        <a href="edit_service_2.php?service_id=<?php echo $row['service_id']; ?>" class="btn btn-info btn-sm">Edit</a>
                        <a href="delete_service_2.php?service_id=<?php echo $row['service_id'];?>" class="btn btn-danger btn-sm  ">Del</a>
                      </td>
                    </tr>
                    <?php
                  }//end of while
