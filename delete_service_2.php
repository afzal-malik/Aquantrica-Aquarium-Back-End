...
<head>
    ...
    <title>Delete Service Information</title>
    ...
    <div class="container" style="padding:0px;">
        <div class="row">
            ...
            <div class="col-lg-8 mt-3">
                ...
                <h3>Delete /Remove Service Info / Step 2/4</h3>
                <hr>
                <?php
                ...
                ?>
                <form action="delete_service_3.php" method="post" class="form my-5 col-lg-8 col-md-8">
                    ...
                    <div class="form-group">
                        <label class="form-label mt-4" for="inputValid">Service Type</label>
                        <input type="text"
                        value="<?php echo $row['service_type']; ?>" name="service_type"
                ...
                <div class="alert alert-dismissible alert-danger">
                    ...
                    <strong>Sorry</strong>
                    No Records were found for Service ID <?php echo $service_type; ?>
                    <br>
                    <a href="delete_service_1.php" class="btn btn-danger mt-5">Try Again</a>
                </div>
                <?php
              }
                 ?>
