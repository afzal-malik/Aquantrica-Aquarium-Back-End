...
<head>
    ...
    <title>Add new service step 3/3</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 mt-3">
                ...
                <div class="alert alert-dismissible alert-success">
                    ...
                    <br>
                    <a href="add_service_1.php" class="btn btn-success mt-5">Add Another Record</a>
                </div>
                ...
                <div class="alert alert-dismissible alert-danger">
                    ...
                    <br>
                    <a href="add_service_1.php" class="btn btn-danger mt-5">Try Again</a>
                </div>
                <?php
